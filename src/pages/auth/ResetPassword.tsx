            ...
            <div className="flex-1 bg-gray-50 p-8 flex flex-col">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <form onSubmit={handleSubmit} className="w-full max-w-md p-6 rounded-lg space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">{t("phone_email_label")}</label>
                            <input
                                type="text"
                                value={emailOrPhone}
                        ...
                        <button type="submit" className="bg-blue-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-700 transition" disabled={loading}>
                        {loading ? (
                  <>
