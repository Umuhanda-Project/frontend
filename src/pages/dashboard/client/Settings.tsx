        ...
        >
          ...
          <ToastContainer position="top-right" />
            ...
            <form onSubmit={handleChangePassword}>
              <input required type="password" value={passwordData.current_password} id="current_password" placeholder={t('current_password')} onChange={handlePasswordChange} className="w-full border px-4 py-2 rounded mt-3" />
              <input required type="password" value={passwordData.new_password} id="new_password" placeholder={t('new_password')} onChange={handlePasswordChange} className="w-full border px-4 py-2 rounded mt-3" />
              <input required type="password" value={passwordData.confirm_password} id="confirm_password" placeholder={t('confirm_new_password')} onChange={handlePasswordChange} className="w-full border px-4 py-2 rounded mt-3" />
              <button type="submit"  className={`mt-4 bg-indigo-600 text-white py-2 px-6 rounded shadow hover:bg-indigo-700 ${!isChangePasswordValid ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-600" }`}
